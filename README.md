...
To look at private repositories, you'll need to pass a [personal access token]() as `GITHUB_TOKEN`. You can do this by adding `GITHUB_TOKEN=[TOKEN]` to a `.env` file in the repository's root. This assumes you can clone the repositories via Git.
